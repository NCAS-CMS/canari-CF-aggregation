...
% --- Header Setup ---
\rhead{\includegraphics[width=4cm]{figures/NCAS_logo_transparent.png}} 
...
\rhead{\includegraphics[width=4cm]{figures/NCAS_logo_transparent}} 
...
For the historical ensemble, members 1-13 have slightly different variable sets\footnote{see \url{https://ncas-cms.github.io/canari-data/}} to the remainder. Therefore, members 2-12 were seeded from member 1, \texttt{u-dv575}, and 14-40 were seeded from member 13, \texttt{u-cy537}. All SSP3-7.0 members were seeded from its first member, \texttt{u-de814}.
