...
#
#    --cycle <year><month> - Get a single cycle (instead of start/end)
#
...
class JDMAInterface():
    ...
    def submit_get(self, suite, ens_num, startdate, enddate, months, flist):
        ...
        if FILE_LIST:
            ...
            print('Writing list of files to {}\n'.format(filelist_out))
            all_files = []
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--end', type=int, help="Year to extract data up to (included)")
